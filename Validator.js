function Validator(formSelector) {
    ...
    let validatorRules = {
        ...
        phone: function (value) {
            let phonePattern = "";
            return phonePattern.test(value) ? undefined : "Vui lòng nhập đúng sdt";
        },
    };
    ...
    function handleValidate(event) {
        ...
        if (errorMessage) {
            ...
            let fromMessage = formGroup.querySelector(".form-message");
            if (!fromMessage) return;
            fromMessage.innerText = "Looks Good!";
        }
    ...
    formElement.onreset = (event) => {
        let validFormGroups = document.querySelectorAll(".valid");
        for (let formGroup of validFormGroups) {
            formGroup.classList.remove("valid");
            let fromMessage = formGroup.querySelector(".form-message");
            if (!fromMessage) return;
            fromMessage.innerText = "";
